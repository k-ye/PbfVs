...
////////////////////////////////////////////////////
// Trait helpers
template <typename T> struct TypeTrait { typedef T type; };

template <bool cond, typename Then, typename Else> struct IfElse {
  typedef Else type;
};

template <typename Then, typename Else> struct IfElse<true, Then, Else> {
  typedef Then type;
};
} // namespace pbf
