...
PbfSolverBase::PbfSolverBase()
    : h_(0.0f), mass_(0.0f), rho_0_(0.0f), rho_0_recpr_(0.0f), epsilon_(0.0f),
      num_iters_(0), corr_delta_q_coeff_(0.0f), corr_k_(0.0f), corr_n_(0.0f),
      vorticity_epsilon_(0.0f), xsph_c_(0.0f), world_size_x_(0.0f),
      world_size_y_(0.0f), world_size_z_(0.0f), ps_(nullptr) {}
...
void PbfSolverBase::Configure(const PbfSolverConfig &config) {
  ...
  world_size_x_ = config.world_size_x;
  world_size_y_ = config.world_size_y;
  world_size_z_ = config.world_size_z;
