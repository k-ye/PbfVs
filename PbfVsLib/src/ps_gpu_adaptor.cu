...
namespace pbf {
    void ParticleSystemGpuAdaptor::Precondition_() const { assert((ps_ != nullptr) && inited_); }
    ...
    const ParticleSystemGpuAdaptor::vector_t& ParticleSystemGpuAdaptor::PositionsVec() const { 
        Precondition_();
        return d_positions_;
    }
    ...
    const ParticleSystemGpuAdaptor::vector_t& ParticleSystemGpuAdaptor::VelocitiesVec() const {
        Precondition_();
        return d_velocities_;
    }
} // namespace pbf