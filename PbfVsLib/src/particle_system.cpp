...
namespace pbf
{
    ...
    ParticleSystem::Particle ParticleSystem::Add(const point_t& p, const point_t& v)
    {
    ...
    ParticleSystem::index_t ParticleSystem::Add(size_t n, const point_t& p, const point_t& v)
    {
        index_t pi = particles_.size();
